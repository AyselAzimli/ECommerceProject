...
namespace ECommerce.MVC.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<IdentityRole> roleManager, FileService fileService, IMailService mailService)
        {
